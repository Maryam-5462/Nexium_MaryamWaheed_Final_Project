...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#1f1b3a] via-[#4c1d95] to-[#0f0c29] text-white px-6 py-8">
//       <h1 className="text-4xl font-extrabold text-purple-300 mb-4">📂 Saved Resumes</h1>
//       <p className="text-gray-300 mb-8">Here you'll find all your previously saved resumes.</p>

//       {/* Add saved resumes listing here later */}
//       <div className="bg-white/10 backdrop-blur-xl border border-purple-500 text-white p-6 rounded-2xl shadow-md">
//         <p className="text-gray-400 italic">No resumes saved yet.</p>
//       </div>
//     </div>
//   )
// }'use client'
